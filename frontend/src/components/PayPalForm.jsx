...
export default function PayPalForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await fetch("http://localhost:8000/paypal/pagar", {
      method: "POST",
      headers: {
    ...
    alert(data.mensagem || "Pagamento via PayPal enviado.");
    setValor("");
    setDescricao("");
  };
  ...
  return (
    ...
    >
      <h2 className="text-xl font-semibold text-indigo-700">Pagamento via PayPal</h2>
