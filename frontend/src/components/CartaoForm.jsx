...
export default function CartaoForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await fetch("http://localhost:8000/cartao/pagar", {
      method: "POST",
      headers: {
    ...
    alert(data.mensagem || "Pagamento via cartão enviado.");
    setValor("");
    setDescricao("");
  };
  ...
  return (
    ...
    >
      <h2 className="text-xl font-semibold text-indigo-700">Pagamento via Cartão</h2>
