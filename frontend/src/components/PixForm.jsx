...
export default function PixForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await fetch("http://localhost:8000/pix/pagar", {
      method: "POST",
      headers: {
    ...
    alert(data.mensagem || "Pagamento enviado.");
    setValor("");
    setDescricao("");
  };
  ...
  return (
    ...
    >
      <h2 className="text-xl font-semibold text-indigo-700">Pagamento via PIX</h2>
